...
<html>
  ...
  <script>
    ...
    var resume_male_normalweight = {
      type: 'instructions',
      pages: [
        '<iframe src="https://psych.shawntylerschwartz.com/psych100b/experiment/src/resumes/BLS_Group_3/NW_M_CSUN.php" width="100%" height="1850px" frameborder="0" scrolling="auto" />',
    ...
    var resume_female_normalweight = {
      type: 'instructions',
      pages: [
        '<iframe src="https://psych.shawntylerschwartz.com/psych100b/experiment/src/resumes/BLS_Group_3/NW_F_SFSU.php" width="100%" height="1850px" frameborder="0" scrolling="auto" />',
        'You will now answer some questions regarding the resume that you just read. Click next to continue.'
      ],
      show_clickable_nav: true
    };
    ...
    var resume_female_overweight = {
      type: 'instructions',
      pages: [
        '<iframe src="https://psych.shawntylerschwartz.com/psych100b/experiment/src/resumes/BLS_Group_3/OW_F_STAN.php" width="100%" height="1850px" frameborder="0" scrolling="auto" />',
        'You will now answer some questions regarding the resume that you just read. Click next to continue.'
      ],
      show_clickable_nav: true
    };
    ...
    var resume_male_overweight = {
      type: 'instructions',
      pages: [
        '<iframe src="https://psych.shawntylerschwartz.com/psych100b/experiment/src/resumes/BLS_Group_3/OW_M_UCB.php" width="100%" height="1850px" frameborder="0" scrolling="auto" />',
        'You will now answer some questions regarding the resume that you just read. Click next to continue.'
      ],
      show_clickable_nav: true
    };
